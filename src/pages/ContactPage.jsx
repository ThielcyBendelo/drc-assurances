  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 flex flex-col">
      <NavbarSecured />
            ...
            {/* En-tête Institutionnel unifié, premium, animé et connecté aux assets */}
      <header className="relative bg-slate-100 dark:bg-slate-950 px-6 py-24 pt-32 text-center border-b-4 border-[#00A3E0] overflow-hidden font-sans select-none">
        ...
        {/* 1. L'IMAGE D'ARRIÈRE-PLAN LUMINEUSE ET TOTALEMENT VISIBLE DEPUIS LES ASSETS */}
        <div className="absolute inset-0 z-0">
          <img 
            src={background2} 
            alt="DRC Assurances Support Background" 
        ...
        >
          ...
          {/* Badge d'Urgence Animé et Pulse Épousant les Couleurs Nationales */}
          <motion.div
            initial={{ opacity: 0, y: -10 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ delay: 0.15, type: "spring" }}
          >
            <span className="px-4 py-1.5 rounded-full bg-white/90 dark:bg-slate-900/90 text-[#CE1126] dark:text-red-400 text-xs font-black uppercase tracking-widest border border-red-200 dark:border-red-900/50 inline-flex items-center gap-2 shadow-sm animate-pulse">
              <FaClock /> Assistance & Sinistres 24h/7
            </span>
          </motion.div>

          {/* Titre Institutionnel avec gestion de la lisibilité et couleur rouge en mode clair */}
          <motion.h1 
          ...
          >
            Contactez le Centre de Relation <br />
            <span className="text-[#00A3E0] dark:text-[#00A3E0] drop-shadow-[0_1px_2px_rgba(0,0,0,0.1)]">DRC Assurances</span>
          </motion.h1>
          ...
          <motion.p 
            ...
            className="text-slate-700 dark:text-slate-200 max-w-xl mx-auto text-base font-bold leading-relaxed"
          >
